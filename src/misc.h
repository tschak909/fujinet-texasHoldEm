...
// query worst case: "?table=" + 8-char table id + "&player=" + an 11-char
// lobby username + NUL = 35. (5 Card Stud shipped 24 here; that was a latent
// overflow, not a target.)
#define QUERY_LEN       36
...
#ifdef BUILD_COLECO
/*
  The ColecoVision has 1K of RAM and this union is 429 bytes of it, so the
